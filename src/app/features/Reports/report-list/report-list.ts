...
export class ReportList {
  ...
  reports: Report[] = [
    // Financial Statements
    { name: 'Trial Balance', description: 'Account-wise debit and credit balances', routerLink: '/reports/trial-balance', category: 'Financial Statements' },
    { name: 'Balance Sheet', description: 'Assets, liabilities and equity statement', routerLink: '/reports/balance-sheet', category: 'Financial Statements' },
    { name: 'Profit and Loss', description: 'Revenue, expenses and net income statement', routerLink: '/reports/profit-loss-statement', category: 'Financial Statements' },
    { name: 'COA', description: 'Chart of accounts with ledger grouping', routerLink: '/reports/chart-of-accounts', category: 'Financial Statements' },
    // sales
